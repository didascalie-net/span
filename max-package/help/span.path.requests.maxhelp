...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 93.25116, 73.0, 16.0 ],
					"presentation_rect" : [ 57.0, 99.251129, 0.0, 0.0 ],
					"text" : "checkpaths"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "checkpath PathOfAFile/PathOfAFolder : It will check if this paths exists or not. valid = 0 for all paths which does not exist"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.666668, 180.859955, 39.0, 16.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 113.333336, 205.026611, 755.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 128.63678, 630.0, 18.0 ],
					"text" : "getpath PathOfAFile/PathOfAFolder type MooV : It will give you back all the Movie-files inside this folder (recursively)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 112.026611, 600.0, 18.0 ],
					"text" : "getpath PathOfAFile/PathOfAFolder type fold : It will give you back all the folders inside this folder  (recursively)",
					"textcolor" : [ 0.0, 0.0, 0.0, 0.9 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 83.251129, 338.0, 18.0 ],
					"text" : "curent messages accepted : getpath- checkpath - consolidate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 62.668945, 73.0, 16.0 ],
					"text" : "consolidate"
				}
